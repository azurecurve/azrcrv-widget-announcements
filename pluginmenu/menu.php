 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'azrcrv_create_plugin_menu_wa' ) ) {
	function azrcrv_create_plugin_menu_wa() {
		azrcrv_populate_plugin_menu_wa();
	}
}
 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'azrcrv_populate_plugin_menu_wa' ) ) {
	function azrcrv_populate_plugin_menu_wa() {
